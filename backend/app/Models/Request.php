...
class Request extends Model
{
    ...
    {
        return $this->hasOne(RequestText::class, 'id', 'text_id');
    }
    ...
    public function addImages(array | null $images){
        if(!$images) return;
    ...
    public function addImage(UploadedFile $file){
        ...
        if(!in_array(pathinfo($originalName)['extension'], self::ALLOWED_EXTENSIONS)){
            return;
        }
    ...
    public function save(array $options = [])
    {
        if($options){
            ...
            if(isset($options['text'])){
                $text = new RequestText(['value' => $options['text']]);
                $text->save();
